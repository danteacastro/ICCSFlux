"""
MQTT Interface for CFP Node V2
...
class MQTTInterface:
    ...
    def topic_base(self) -> str:
        """Get node-prefixed topic base (e.g., 'nisystem/nodes/cfp-001')."""
    ...
    def setup_standard_subscriptions(self):
        """Set up standard subscriptions for CFP node."""
        base = self.topic_base
        ...
        self.subscribe(f"{base}/interlock/#")    # Interlock commands
