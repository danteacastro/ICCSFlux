#!/usr/bin/env python3
"""
Generate a professional PDF from ICCSFlux_Python_Scripting_Guide.md
...
def add_header_footer(canvas, doc):
    ...
    canvas.drawString(inch, letter[1] - 26, "ICCSFlux Python Scripting Guide")
...
if __name__ == '__main__':
    ...
    md_path = script_dir / 'ICCSFlux_Python_Scripting_Guide.md'
    pdf_path = script_dir / 'ICCSFlux_Python_Scripting_Guide.pdf'
