...
EXCLUDE_FILES = {
    ...
    # GTI-related project configs (proprietary client work)
    ...
    # GTI-related exports and archive configs
    ...
    # ICCSFlux session exports (may contain GTI data)
    ...
    # GTI-specific test/generation scripts
...
SCRUB_PATTERNS = [
    ...
    (re.compile(r'Security Compliance'), "Security Compliance"),
